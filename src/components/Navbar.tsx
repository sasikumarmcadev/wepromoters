...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-8 left-0 right-0 z-[100] px-4 sm:px-12 pointer-events-none">
      <div
        className={cn(
          "mx-auto flex items-center justify-between pointer-events-auto transition-all duration-1000 ease-[cubic-bezier(0.23,1,0.32,1)] relative h-16",
          pastHero ? "max-w-[580px] px-6" : "max-w-7xl px-0"
        )}
      >
        {/* Background Layer: Morphing Glass Body */}
        <div
          className={cn(
            "absolute inset-0 transition-all duration-1000 ease-[cubic-bezier(0.23,1,0.32,1)] rounded-[2rem] -z-1 border border-white/0",
            pastHero
        ...
        >
          ...
          <div className="absolute inset-0 rounded-[2rem] overflow-hidden opacity-50">
        ...
        <div className="relative z-10 flex-shrink-0 flex items-center">
          <a
            href="#"
            className="flex items-center space-x-3 transition-transform hover:scale-105 active:scale-95 duration-500"
          ...
          >
            <img
              ...
              className={cn(
                ...
                pastHero ? "h-6 brightness-110" : "h-9 brightness-0 invert opacity-90"
              )}
            />
          </a>
        </div>
        ...
        <div className="flex items-center gap-2 relative z-10">
          <div
            className={cn(
              "flex items-center rounded-2xl transition-all duration-1000 ease-[cubic-bezier(0.23,1,0.32,1)] p-1",
              pastHero
            ...
            {navLinks.map((link) => {
              ...
              return (
                <a
                  ...
                  className={cn(
                    "relative px-5 py-2 rounded-xl text-[11px] font-bold tracking-wider transition-all duration-500 hover:transition-none",
                    isAction
