...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-4 sm:top-8 left-0 right-0 z-[100] px-3 sm:px-12 pointer-events-none">
      <div
        className={cn(
          "mx-auto flex items-center justify-between pointer-events-auto transition-all [transition-duration:1000ms] [transition-timing-function:cubic-bezier(0.23,1,0.32,1)] relative h-14 sm:h-16",
      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 rounded-2xl sm:rounded-[2rem] overflow-hidden opacity-50">
            <div className="absolute top-0 -left-[100%] w-[50%] h-full bg-gradient-to-r from-transparent via-white/[0.05] to-transparent skew-x-[-25deg] group-hover:left-[150%] transition-all [transition-duration:1500ms]" />
          </div>
        </div>
        ...
        <div className="relative z-10 flex-shrink-0 flex items-center">
          ...
          >
            <img
              ...
              alt="Logo"
              className={cn(
                "w-auto transition-all duration-1000 [transition-timing-function:cubic-bezier(0.23,1,0.32,1)]",
        ...
        <div className="flex items-center gap-1 sm:gap-2 relative z-10">
          <div
            className={cn(
              "flex items-center rounded-xl sm:rounded-2xl transition-all duration-1000 [transition-timing-function:cubic-bezier(0.23,1,0.32,1)] p-0.5 sm:p-1",
              pastHero
